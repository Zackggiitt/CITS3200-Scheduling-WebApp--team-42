...
from models import db, User, UserRole, Module, FacilitatorSkill, SkillLevel, Unavailability
...
def add_sample_facilitators():
    ...
    with app.app_context():
        ...
        for facilitator_data in facilitators_data:
            ...
            # Skip adding availability data since we're using unavailability model
            # The facilitator will be available by default except for specific unavailable times
            pass
